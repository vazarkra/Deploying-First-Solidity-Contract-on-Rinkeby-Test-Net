...
const provider = new HDWalletProvider('12 phrases of MetaMask Account',
'https://rinkeby.infura.io/v3/7a2d89139fc5469b860422c3afe42c5a' );
const web3 = new Web3(provider);
const message = 'Deployed to Rinkeby TestNet !!'
...
const deploy = async () => {
    ...
    .deploy({data: '0x'+ evm.bytecode.object, arguments: [message]}) //tells we want to deploy an instance  
